...
Revolution R Open consists of various open source components and one 
proprietary third party component.  This document describes the license terms 
and other legal considerations that apply to such components.
...
for Statistical Computing.  Such components are licensed pursuant to the GNU 
GPLv2 license and other open source licenses.  A list of the open source 
components and links to the text of the applicable licenses can be at the end 
of this file. You are solely responsible for compliance with such licenses.
...
to you by Revolution Analytics. The MKL is provided "AS IS" without warranty of
any kind. 
...
(c) removing any copyright or other proprietary notices from the MKL files. 
...
The copyright to the MKL is owned by the Intel Corporation.  Additional 
information regarding the MKL is located at 
