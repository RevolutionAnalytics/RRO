[Icons]
Name: "{group}\Microsoft R Open Rgui @RVER@ 64-bit"; Filename: "{app}\bin\x64\Rgui.exe"; IconFilename: "{app}\etc\REV_14419_Clark_2C.ico"; WorkingDir: "{userdocs}"; Check: isComponentSelected('x64') and Is64BitInstallMode

Name: "{commondesktop}\Microsoft R Open Rgui @RVER@ 64-bit"; Filename: "{app}\bin\x64\Rgui.exe"; MinVersion: 0,5.0; IconFilename: "{app}\etc\REV_14419_Clark_2C.ico"; Tasks: desktopicon; WorkingDir: "{userdocs}"; Check: isComponentSelected('x64') and Is64BitInstallMode

Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Microsoft R Open Rgui @RVER@ 64-bit"; Filename: "{app}\bin\x64\Rgui.exe"; IconFilename: "{app}\etc\REV_14419_Clark_2C.ico"; Tasks: quicklaunchicon; WorkingDir: "{userdocs}"; Check: isComponentSelected('x64') and Is64BitInstallMode 
