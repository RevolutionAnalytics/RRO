[Icons]
Name: "{group}\RRO Rgui @RVER@ 32-bit"; Filename: "{app}\bin\i386\Rgui.exe"; IconFilename: "{app}\etc\REV_14419_Clark_2C.ico"; WorkingDir: "{userdocs}"; Parameters: {code:CmdParms}; Check: isComponentSelected('i386')
