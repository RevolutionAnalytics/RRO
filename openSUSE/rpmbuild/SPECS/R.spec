...
Requires: gcc gcc48-fortran, gcc-c++, libpng, readline, cairo-devel
...
echo 'install.packages("checkpoint",repos="http://mran.revolutionanalytics.com/snapshot/2014-11-20"))' | R -q --vanilla
%postun
