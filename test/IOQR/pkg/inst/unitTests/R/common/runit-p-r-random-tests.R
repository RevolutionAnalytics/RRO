...
"p.r.random.tests.stress" <- function()
{
...
"test.p.r.random.tests.stress" <- function()
{
    res <- try(p.r.random.tests.stress())
    checkTrue(!is(res, "try-error"), msg="p.r.random.tests stress test failed")
}
